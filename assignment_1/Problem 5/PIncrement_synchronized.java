...
public class PIncrement {
    ...
    private final static int m = 1200000;
      ...
      private static class PIncrementThread extends Thread {
        ...
        public void run() {
           int c = incrementNumber(1,m); // increments c with synchronized access for each thread
         ...
         */
        synchronized private static void incrementNumber(int min, int m) {
              int c = 0;
              if (numThreads != 7) {
